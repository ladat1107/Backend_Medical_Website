...
export const createRelativeController = async (req, res) => {
    try {
        let data = req.body;
        if (data && data.fullName && data.cid && data.phoneNumber && data.relationship && data.address && data.userId) {
...
export const updateRelativeController = async (req, res) => {
    try {
        let data = req.body;
        if (data && data.id && data.fullName && data.cid && data.phoneNumber && data.relationship && data.address) {
